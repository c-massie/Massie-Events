...
Instead of using `IEvent<...>` and `Event<...>`, you can use `IPriorityEvent` and `OrderedEvent` to declare an event where listeners can be registered with support for priorities.
